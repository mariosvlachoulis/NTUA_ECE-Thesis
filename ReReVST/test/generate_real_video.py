...
# Target style
style_img = './inputs/mondrian.jpg'

# Target content video
# Use glob.glob() to search for all the frames
# Add sort them by sort()
content_video = 'C://Users/Marios/Desktop/DIPLOMA/ReReVST/ReReVST-Code-master/data/MPI/training/final/market_2/*.png'

# Path of the checkpoint (please download and replace the empty file)
checkpoint_path = "C://Users/Marios/Desktop/DIPLOMA/ReReVST/ReReVST-Code-master/train/train_results/1st round/style_net-epoch-0.pth"
...
for i in range(frame_num):
    ...
    # Save result
    # cv2.imwrite(os.path.join(result_frames_path, name, str(i) + ".png" ), styled_input_frame)
    cv2.imwrite('{}/{}/{}'.format(result_frames_path, name, 
                                   str(i) + ".png"), styled_input_frame)
